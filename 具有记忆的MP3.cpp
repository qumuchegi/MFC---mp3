// 具有记忆的MP3.cpp : Defines the class behaviors for the application.
//
...
BOOL CMP3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMP3Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CMP3View));
...
HBRUSH CAboutDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
	...
	case CTLCOLOR_STATIC://静态文本
		...
		HBRUSH B=CreateSolidBrush(RGB(217,178,92));
